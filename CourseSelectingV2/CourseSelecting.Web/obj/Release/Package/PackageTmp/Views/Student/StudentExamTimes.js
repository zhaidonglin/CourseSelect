    ...
    $(function () {
        ...
        $('#calendar').fullCalendar({
            ...
            events: function (start, end, callback) {
                courseService.getStudentCourseExamTimes({
                    Start: start,
                    End: end
                    ...
                    for (var index in result.items) {
                        ...
                        } else if ( !itemObj.enabledEndTime || itemObj.enabledStartTime) {
                        ...
                        success: {
                            ...
                            callback: function () {
                                ...
                                if (calEvent.isSelected) {
                                    courseService.studentCourseExamTimeDeleteOrdered(calEvent.id).done(function () {
                                ...
                                } else if ( !calEvent.enabledEndTime || calEvent.enabledTime) {
                                    bootbox.alert("<div class=\"modal-body\">预约失败,考试时间已过期!</div>");
                                } else {
                                    courseService.studentCourseExamTimeAdd(calEvent.id).done(function () {
