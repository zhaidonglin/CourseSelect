                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        ...
                        //if (!rowData.isCompulsory) {
                            ...
                            if (rowData.isSelected) {
                                htmlstr = '<a href="javascript:void(0);" onclick="fnDeleteSubject(' + cellData + ')" class="btn btn-danger btn-xs delete"><i class="fa"></i>已选</a>';
                            } else {
                                htmlstr = '<a "javascript:void(0);" id="color" onclick="fnSelectSubject(' + cellData + ')" class="btn btn-info btn-xs edit"><i class="fa"></i>未选</a>';
                            }
                        //}
