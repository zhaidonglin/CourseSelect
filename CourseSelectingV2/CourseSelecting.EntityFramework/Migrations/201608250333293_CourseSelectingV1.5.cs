namespace CourseSelecting.Migrations
{
    ...
    public partial class CourseSelectingV15 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        TenantId = c.Int(),
                        SubjectProjectId = c.Int(nullable: false),
                        Name = c.String(nullable: false, maxLength: 128),
                        Credit = c.Double(nullable: false),
                        LimitNumbers = c.Int(nullable: false),
                        SelectedNumbers = c.Int(nullable: false),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Course_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_Course_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CsSubjectProjects", t => t.SubjectProjectId, cascadeDelete: true)
                .Index(t => t.SubjectProjectId);
            
            CreateTable(
                "dbo.CsSubjectProjects",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TenantId = c.Int(),
                        Name = c.String(nullable: false, maxLength: 128),
                        SubjectStyle = c.String(maxLength: 64),
                        Type = c.String(maxLength: 64),
                        Credit = c.Double(nullable: false),
                        AimedAt = c.String(maxLength: 64),
                        IsCompulsory = c.Boolean(nullable: false),
                        TeachingStyle = c.String(maxLength: 64),
                        Discription = c.String(maxLength: 2048),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SubjectProject_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_SubjectProject_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CsSemesters", t => t.SemesterId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Semester_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_Semester_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        Start = c.DateTime(nullable: false),
                        Address = c.String(maxLength: 521),
                        CreationTime = c.DateTime(nullable: false),
                        CreatorUserId = c.Long(),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_CourseTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CsTeacherCourses", t => t.TeacherCourseId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_TeacherCourse_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CsCourses", t => t.CourseId, cascadeDelete: true)
                .ForeignKey("dbo.CsTeachers", t => t.TeacherId)
                .Index(t => t.CourseId)
                .Index(t => t.TeacherId);
                ...
                c => new
                    {
                        ...
                        Start = c.DateTime(nullable: false),
                        Address = c.String(maxLength: 521),
                        Teacher = c.String(maxLength: 128),
                        CreationTime = c.DateTime(nullable: false),
                        CreatorUserId = c.Long(),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_ExamTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CsTeacherCourses", t => t.TeacherCourseId, cascadeDelete: true)
                .Index(t => t.TeacherCourseId);
            ...
            CreateTable(
                "dbo.CsStudentCourseTimes",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TenantId = c.Int(),
                        CourseTimeId = c.Int(nullable: false),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentCourseTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            
            CreateTable(
                "dbo.CsStudentExamTimes",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TenantId = c.Int(),
                        ExamTimeId = c.Int(nullable: false),
                        StudentId = c.Long(nullable: false),
                        CreationTime = c.DateTime(nullable: false),
                        CreatorUserId = c.Long(),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentExamTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            
            CreateTable(
                "dbo.CsStudentSubjectProjects",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TenantId = c.Int(),
                        CourseId = c.Int(nullable: false),
                        StudentId = c.Long(nullable: false),
                        ClassCredit = c.Double(nullable: false),
                        ExamCredit = c.Double(nullable: false),
                        TotalCadit = c.Double(nullable: false),
                        CreationTime = c.DateTime(nullable: false),
                        CreatorUserId = c.Long(),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentSubjectProject_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        StudentNo = c.String(maxLength: 64),
                        Gender = c.Int(nullable: false),
                        Tel = c.String(maxLength: 32),
                        Major = c.String(maxLength: 128),
                        Grade = c.String(maxLength: 128),
                        Class = c.String(maxLength: 64),
                        OriginOfStudent = c.String(maxLength: 1024),
                        Department = c.String(maxLength: 128),
                        ProfessionLevel = c.String(maxLength: 64),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Student_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Long(nullable: false),
                        TeacherNo = c.String(maxLength: 64),
                        Department = c.String(maxLength: 128),
                        Gender = c.Int(nullable: false),
                        Major = c.String(maxLength: 128),
                        Diploma = c.String(maxLength: 32),
                        Degree = c.String(maxLength: 32),
                        PositionalTitle = c.String(maxLength: 128),
                        Tel = c.String(maxLength: 32),
                        YearsOfWorking = c.String(maxLength: 64),
                        YearsOfTeaching = c.String(maxLength: 64),
                        IsFullTime = c.Boolean(nullable: false),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Teacher_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
        ...
        {
            DropForeignKey("dbo.CsTeachers", "Id", "dbo.AbpUsers");
            DropForeignKey("dbo.CsStudents", "Id", "dbo.AbpUsers");
            ...
            DropForeignKey("dbo.CsTeacherCourses", "TeacherId", "dbo.CsTeachers");
            ...
            DropForeignKey("dbo.CsExamTimes", "TeacherCourseId", "dbo.CsTeacherCourses");
            DropForeignKey("dbo.CsCourseTimes", "TeacherCourseId", "dbo.CsTeacherCourses");
            DropForeignKey("dbo.CsTeacherCourses", "CourseId", "dbo.CsCourses");
            DropForeignKey("dbo.CsSubjectProjects", "SemesterId", "dbo.CsSemesters");
            DropForeignKey("dbo.CsCourses", "SubjectProjectId", "dbo.CsSubjectProjects");
            DropIndex("dbo.CsTeachers", new[] { "Id" });
            DropIndex("dbo.CsStudents", new[] { "Id" });
            ...
            DropIndex("dbo.CsExamTimes", new[] { "TeacherCourseId" });
            DropIndex("dbo.CsTeacherCourses", new[] { "TeacherId" });
            DropIndex("dbo.CsTeacherCourses", new[] { "CourseId" });
            DropIndex("dbo.CsCourseTimes", new[] { "TeacherCourseId" });
            DropIndex("dbo.CsSubjectProjects", new[] { "SemesterId" });
            DropIndex("dbo.CsCourses", new[] { "SubjectProjectId" });
            DropIndex("dbo.AbpBackgroundJobs", new[] { "IsAbandoned", "NextTryTime" });
            DropTable("dbo.CsTeachers",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Teacher_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_Teacher_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsStudents",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Student_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_Student_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
            ...
            DropTable("dbo.CsStudentSubjectProjects",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentSubjectProject_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsStudentExamTimes",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentExamTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsStudentCourseTimes",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_StudentCourseTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            ...
            DropTable("dbo.CsExamTimes",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_ExamTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsTeacherCourses",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_TeacherCourse_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsCourseTimes",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_CourseTime_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsSemesters",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Semester_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_Semester_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsSubjectProjects",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SubjectProject_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_SubjectProject_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.CsCourses",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Course_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_Course_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
