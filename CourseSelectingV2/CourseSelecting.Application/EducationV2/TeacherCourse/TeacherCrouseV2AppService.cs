...
{
    public class TeacherCrouseV2AppService : CourseSelectingAppServiceBase, ITeacherCrouseV2AppService
    {
        private readonly IRepository<Education.TeacherCourse> _teacherCourseRepository;

        public TeacherCrouseV2AppService(
        ...
        public async Task<PagedResultDto<TeacherCourseDto>> Query(TeacherCourseQueryInput input)
        {
            ...
            //获取总数
            var totalcount = await _teacherCourseRepository.CountAsync();
